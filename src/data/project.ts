...
export const projects = [
...

    {
        ...
        description: "Desarrollo de plataforma Web de gestión de PQRS para <strong>la Feria del brasier y solo kuko's</strong>, con módulo de administración para la gestión del proyecto. Sistema de gestión de peticiones, quejas, reclamos y solicitudes, con notificaciones, seguimiento y reportes.",
