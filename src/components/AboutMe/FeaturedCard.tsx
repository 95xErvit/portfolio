...
export default function FeatureCard({icon: Icon, title, description,}: Props) {
    return (
        <article className="flex flex-col lg:flex-row items-center md:items-start gap-6">
            <div className="w-20 h-20 rounded-3xl bg-white shadow-[0_10px_30px_rgba(0,0,0,.04)] flex items-center justify-center shrink-0">
                <Icon size={34} className="text-green-title" />
            </div>

            <div className="w-full">
                <h3 className="text-center md:text-start text-xl md:text-2xl font-semibold text-principal-text">
                    {title}
                </h3>
